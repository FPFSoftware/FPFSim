...
|/out/saveTrack    | if `true` save full trajectories, `false` by default |
|/out/parKinECut   | set particle kinetic energy threshold for saving in output tree (default: `100 keV`) |
